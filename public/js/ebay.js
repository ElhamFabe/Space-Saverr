    ...
    $("#spaceSearch").click(function(e) {
      ...
      fetch(`/search?keyword=${searchText}`)
        ...
        .then((data) => {
          ...
          // var mySection = $("#dealCards");
          // // makes first row
          // var rowSet2 = $(".row" + rowCounter);
          // var rowSet = $(".row" + rowCounter);
          // var elements = $(".r" + i);
          ...
          //   $(rowSet).appendTo(makeArticle);
          //   elements.html(appendEbaySearch);
          // } else if (i === 0) {
          //   console.log("else if statement");
          //   var makeFirstSection = $("<section>");
          //   makeFirstSection.addClass("row");
          //   makeFirstSection.addClass("row1");
          //   $(makeFirstSection).appendTo(mySection);
          // } else {
          //   console.log("else statement");
          //   var makeArticle2 = $("<section>");
          //   makeArticle2.attr("id", "r" + i);
          //   $(rowSet2).appendTo(makeArticle2);
          //   elements.html(appendEbaySearch);
          // }
    ...
    fetch("https://www.ebay.com/rps/feed/v1.1/ebay-us?eBayCatId=" + catID)
      ...
      .then((data) => {
        ...
        for (var i = 1; i < 3; i++) {
          for (
            var i = 1;
            i < jsonResults.content[0].content[1].content[2].content.length;
            i++
          ) {
            for (var j = 0; j < 11; j++) {
              var saverItem1 =
                jsonResults.content[0].content[1].content[2].content[i].content[
                  j
                ].type;
              var saverItem2 =
                jsonResults.content[0].content[1].content[2].content[i].content[
